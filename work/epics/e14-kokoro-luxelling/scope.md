...
- [x] S14.1 — Knowledge curation: create structured .claude/knowledge/luxelling/ files from source material (S)
- [x] S14.2 — /kokoro-luxury-assess: positioning assessment skill + persist tier in client profile (S)
