...
|---|-----|------|------|------------|-----------|--------|
| 1 | S32.1 | Knowledge: Lean Landing Page | S | — | Fundacion. Sin knowledge file el skill no tiene contra que evaluar. Ademas, es reutilizable por /kokoro-launch. | pending |
