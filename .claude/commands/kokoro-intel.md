...
### Oportunidades de Contenido (rankeadas por impacto)

| # | Tema + Angulo | Por que es oportunidad | Impacto | Formato sugerido |
|---|---------------|----------------------|---------|------------------|
| 1 | {tema} | {hueco/debilidad/angulo faltante} | Alto | Horizontal 12 min |
| 2 | {tema} | {razon} | Alto | Short 60s + Horizontal |
| 3 | {tema} | {razon} | Medio | Horizontal 8 min |
| 4 | {tema} | {razon} | Medio | Short 45s |
| 5 | {tema} | {razon} | Bajo | Horizontal 15 min |
...
1. `/kokoro-listen {url}` para profundizar en un video especifico
2. `/kokoro-research` para triangular con fuentes web
3. Usar las oportunidades para planificar tu calendario de contenido
```
